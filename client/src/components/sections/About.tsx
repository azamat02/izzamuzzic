            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              {about?.stat1Value && (
                <div className="text-center">
                  <p className="text-4xl text-[#e63946]" style={{ fontFamily: 'var(--font-heading)' }}>{about.stat1Value}</p>
                  <p className="text-[#a0a0a0] text-sm uppercase">{about.stat1Label}</p>
                </div>
              )}
              {about?.stat2Value && (
                <div className="text-center">
                  <p className="text-4xl text-[#e63946]" style={{ fontFamily: 'var(--font-heading)' }}>{about.stat2Value}</p>
                  <p className="text-[#a0a0a0] text-sm uppercase">{about.stat2Label}</p>
                </div>
              )}
              {about?.stat3Value && (
                <div className="text-center">
                  <p className="text-4xl text-[#e63946]" style={{ fontFamily: 'var(--font-heading)' }}>{about.stat3Value}</p>
