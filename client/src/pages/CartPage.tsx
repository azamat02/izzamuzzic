        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {items.length === 0 ? (
            <div className="text-center py-20">
              ...
              <Link
                to="/merch"
                className="inline-block bg-[#e63946] text-white px-8 py-3 rounded-lg hover:bg-[#ff6b6b] transition-colors font-medium tracking-wider"
              >
                Перейти в магазин
              </Link>
            </div>
            ...
            <>
                ...
                {items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[#e63946] font-medium mt-1">
                    ...
                    <button
                      ...
                      className="text-[#a0a0a0] hover:text-[#e63946] transition-colors p-2"
                    >
              ...
              <div className="mt-8 bg-[#141414] border border-[#1a1a1a] rounded-lg p-6">
                ...
                <Link
                  to="/checkout"
                  className="block w-full bg-[#e63946] text-white text-center px-8 py-3 rounded-lg hover:bg-[#ff6b6b] transition-colors font-medium tracking-wider"
                >
                  Оформить заказ
                </Link>
              </div>
